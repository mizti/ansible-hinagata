...
sshのconfigを配置。githubへのアクセスと、構築対象サーバ(e.g. 153.128.29.165)への鍵設定を行う。
...
※ 153.128.29.165の部分はansible作業の対象サーバのIP。各サーバ毎に記載。
...
ssh-rsa  devuser@portal-ansible
EOF
...
h3. serverspecでの構築後の試験方法

serverspecのテスト項目は、hostsファイル内に記述されている情報を元に自動生成される。
...
<pre>
$ bundle exec rake -T
rake serverspec:openstack-[system]
</pre>
